...
export const employeeOnboardings: EmployeeOnboarding[] = [
  {
    ...
    templateName: "Onboarding Magang",
    startDate: "2026-03-15",
    status: "IN_PROGRESS",
    tasks: [
      { taskId: "t-20", title: "Kumpulkan fotokopi KTP", category: "DOKUMEN", assignee: "KARYAWAN", isCompleted: true, completedAt: "2026-03-15" },
      { taskId: "t-21", title: "Surat pengantar kampus", category: "DOKUMEN", assignee: "KARYAWAN", isCompleted: true, completedAt: "2026-03-15" },
      { taskId: "t-22", title: "Setup email perusahaan", category: "AKUN", assignee: "IT", isCompleted: true, completedAt: "2026-03-15" },
      { taskId: "t-23", title: "Penyerahan laptop/PC", category: "EQUIPMENT", assignee: "IT", isCompleted: true, completedAt: "2026-03-15" },
      { taskId: "t-24", title: "Orientasi perusahaan", category: "TRAINING", assignee: "HR", isCompleted: true, completedAt: "2026-03-15" },
      { taskId: "t-25", title: "Perkenalan tim", category: "LAINNYA", assignee: "MANAGER", isCompleted: false, completedAt: null },
    ],
  },
  {
    id: "onb-2",
    ...
    positionName: "Operations Supervisor",
