    ...
    }),
    {
      ...
      partialize: (state) => {
        const {
          ...
          updatePosition: _j,
          deletePosition: _k,
          addAttendanceRecord: _l,
          updateAttendanceRecord: _m,
          addOvertimeRecord: _n,
          updateOvertimeRecord: _o,
          addHoliday: _p,
          updateHoliday: _q,
          deleteHoliday: _r,
          addLeaveRequest: _s,
          updateLeaveRequest: _t,
          updateLeaveBalance: _u,
          addLeaveType: _v,
          updateLeaveType: _w,
          deleteLeaveType: _x,
          addPayrollPeriod: _y,
          updatePayrollPeriod: _z,
          addPayslip: _aa,
          updatePayslip: _ab,
          addJobPosting: _ac,
          updateJobPosting: _ad,
          deleteJobPosting: _ae,
          addApplicant: _af,
          updateApplicant: _ag,
          addReviewCycle: _ah,
          updateReviewCycle: _ai,
          addPerformanceReview: _aj,
          updatePerformanceReview: _ak,
          addTraining: _al,
          updateTraining: _am,
          deleteTraining: _an,
          addTrainingParticipant: _ao,
          updateTrainingParticipant: _ap,
          addOnboardingTemplate: _aq,
          updateOnboardingTemplate: _ar,
          deleteOnboardingTemplate: _as,
          addEmployeeOnboarding: _at,
          updateEmployeeOnboarding: _au,
          addLifecycleEvent: _av,
          addEmployeeAdvance: _aw,
          updateEmployeeAdvance: _ax,
          addExpenseClaim: _ay,
          updateExpenseClaim: _az,
          addShiftType: _ba,
          updateShiftType: _bb,
          deleteShiftType: _bc,
          addShiftAssignment: _bd,
          updateShiftAssignment: _be,
          deleteShiftAssignment: _bf,
          updateCompanySettings: _bg,
          addActivityItem: _bh,
          ...rest
        } = state;
        return rest;
